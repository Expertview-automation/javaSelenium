...
//      driver.get("google.com");
       ...
       driver.findElement(By.xpath("    //label[text()='User Role']//ancestor::div[@class='oxd-input-group oxd-input-field-bottom-space']//div[@class='oxd-select-text-input']")).click();//sendKeys("Admin");
